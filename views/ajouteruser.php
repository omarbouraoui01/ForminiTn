...
$userC = new userC();
if (isset($_GET['id'])) {
  $userToEdit = $userC->getuserbyID($_GET['id']);
  
}
$listesusers = $userC->afficheruser();

if (isset($_REQUEST['add']) || isset($_REQUEST['edit'])) {
  
          $userC = new userC();
          if (isset($_REQUEST['add'])) {
            $user = new user(1, $_POST['nom'], $_POST['prenom'],  $_POST['sexe'] ,$_POST['email'],$_POST['login'],$_POST['daten'],$_POST['password'],$_POST['role']);
            $userC->ajouteruser($user);
            header('Location:ajouteruser.php');
          } else if (isset($_REQUEST['edit'])) {
            $id=$_GET['id'];
            $userToEdit = new user($id, $_POST['nom'], $_POST['prenom'],  $_POST['sexe'] ,$_POST['email'],$_POST['login'],$_POST['daten'],$_POST['password'],$_POST['role']);
          $userC->modifieruser($userToEdit,$_GET['id']);
          header('Location:ajouteruser.php');
          }
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php foreach ($listesusers as $key) {
                        ?>
                        <tr>
                          <td>
                            <?php echo $key['nom']; ?>
