	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.png');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5"  id="contact" action="verify.php" method="post">
						...
						<input id="pass" name="pass" type="password" class="form-control form-control-lg" placeholder="mot de passe" required="">
					...
					<button class="btn btn-outline-primary"><a href="Register.php">S'inscrire</a></button>
				</form>
